...
%
function [emotionFeatureVector] = createEmotionFeatureVectorFirstLast(emotionDirectory, filterBank)
...
emotionFeatureVector = [emotionFeatureVectorsFirstLast{1} emotionFeatureVectorsFirstLast{2} emotionFeatureVectorsFirstLast{3} emotionFeatureVectorsFirstLast{4} emotionFeatureVectorsFirstLast{5} emotionFeatureVectorsFirstLast{6}];
